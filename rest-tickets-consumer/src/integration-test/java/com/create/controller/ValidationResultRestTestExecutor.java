...
class ValidationResultRestTestExecutor {
    private static final String JSON_EXTENSION = "json";

    private final TestRestTemplate restTemplate;
    private final ObjectMapper objectMapper;

    ValidationResultRestTestExecutor(TestRestTemplate restTemplate,
                                            ObjectMapper objectMapper) {
        this.restTemplate = restTemplate;
        this.objectMapper = objectMapper;
    }

    <T> void executeListTestRestRequest(String urlTemplate,
                                               String testName,
                                               Class<T> type) throws Exception {
        executeTestRestRequest(urlTemplate, testName, List.class, type);
    }

    <T> void executeTestRestRequest(String urlTemplate,
                                           String testName,
                                           Class<T> type) throws Exception {
