...
public class NotBeforeDateTest {
    private NotBeforeDate notBeforeDate = new NotBeforeDate();
    ...
    public void shouldReturnTrueWhenBaseDateIsAfterTermDate(){
        ...
        // when
        final boolean checkConstraint = notBeforeDate.checkConstraint(baseDate, termDate);
    ...
    @Test
    public void shouldReturnTrueWhenBaseDateIsSameAsTermDate(){
        // given
        final LocalDate baseDate = LocalDate.of(2016,8,15);
