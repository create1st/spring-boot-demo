...
public class NestedPathConverter {
    public static final String NESTED_PATH_REGEXP = "target\\[.*?\\]\\.";
    ...
    public String getNestedPath(String targetElement) {
    ...
    public String getTargetName(String targetElement) {
        final Matcher matcher = getNestedPathPatternMatcher(targetElement);
        return matcher.find()
