...
public class PropertyValidationErrorsProvider {
    ...
    public PropertyValidationErrorsProvider(List<ObjectError> objectErrors) {
        propertyValidationErrorsGroupedByNestedPath = getPropertyValidationErrorsGroupedByNestedPath(objectErrors);
    }

    public List<String> getPropertyValidationErrorsByNestedPath(String nestedPath) {
